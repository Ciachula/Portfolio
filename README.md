...
|---|---|---|
| Userform (login+password)| Userform made with VBA and Excel ActiveX control functions. | [View here](https://github.com/Ciachula/Userform-login-pass-) |
| Offset function | Related to project above. To move data from one sheet to another I used offset function which collaborate with ActiveX. | [View here](https://github.com/Ciachula/Offset) |
